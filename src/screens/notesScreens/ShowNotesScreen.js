...
const ShowNotesScreen = () => {
  ...
  const handleEditNavigation = () => {
    navigation.navigate('NotesEditScreen')
  }

  const points = [
    "This meeting shouldn’t be missed at any cost.",
    "It’s really an important meeting with this manager.",
    "This meeting shouldn’t be missed at any cost.",
    "It’s really an important meeting with this manager.",
    "It’s really an important meeting with this manager.",
    "It’s really an important meeting with this manager.",
    ...
    <View style={styles.container}>
      ...
      >
        ...
        {points.map((value,index)=>(
          <Text key={index} style={styles.pointTxt}>{"• "+value+"\n"}</Text>
        ))}
